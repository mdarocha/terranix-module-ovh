{
  description = "terranix ovh module";
  inputs = {
      ...
      (system:
        let
          ...
          terranixOptions = terranix.lib.terranixOptions {
            ...
            urlPrefix = "https://github.com/terranix/terranix-module-ovh/tree/main/module/";
            modules = [ self.terranixModule ];
          };
        in
        {
          ...
          devShells.default = pkgs.mkShell {
            buildInputs = with pkgs; [
              (terraform.withPlugins (p: [ p.ovh ]))
            ];
          };

          formatter = pkgs.nixpkgs-fmt;
        }) // {
      terranixModules.ovh = import ./default.nix;
      terranixModule.imports = [ self.terranixModules.ovh ];
    };
}
